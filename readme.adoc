...
Not quite ready to dive in? Check out our https://github.com/internet-innovation/netrics-docker[guide in the netrics-demo repository].

== Installation

=== Docker images

Netrics publishes a number of https://github.com/internet-innovation/netrics/pkgs/container/netrics[Debian-based Docker images], for the ease of users familiar with Docker, to support otherwise unsupported systems, and otherwise to provision Netrics in systems utilizing containers.

For example, to get started with the default Netrics Docker image:

[source,sh]
----
docker run ghcr.io/internet-innovation/netrics
----
...
[source,sh]
----
curl -sL https://github.com/internet-innovation/netrics/raw/0.0.1/install.py | python3
----
...
[source,sh]
----
curl -sL https://github.com/internet-innovation/netrics/raw/0.0.1/install.py | sudo python3
----
...
[source,sh]
----
curl -sL https://github.com/internet-innovation/netrics/raw/0.0.1/install.py | python3 - --help
----
...
[source,sh]
----
curl -LO https://github.com/internet-innovation/netrics/raw/0.0.1/install.py
...
Find the appropriate build for your system on the https://github.com/internet-innovation/netrics/releases/latest[Netrics release announcement page].
...
NETRICS=$(curl -s https://api.github.com/repos/internet-innovation/netrics/releases/latest | jq -r .tag_name)

curl -sL https://github.com/internet-innovation/netrics/releases/download/$NETRICS/netrics-all-$NETRICS-$PYTHON-$ARCH.tar | sudo tar -xf - -C /usr/local/bin/
----
